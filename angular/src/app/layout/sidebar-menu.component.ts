...
export class SidebarMenuComponent extends AppComponentBase implements OnInit {
  ...
  getMenuItems(): MenuItem[] {
    return [
      ...
      new MenuItem(this.l('Posts'), '/app/posts', 'fas fa-file'),
      new MenuItem(this.l('Authors'), '/app/authors', 'fas fa-users'),
      new MenuItem(this.l('Categories'), '/app/categories', 'fas fa-th-list'),
      new MenuItem(
        this.l('Tenants'),
        '/app/tenants',
        'fas fa-building',
