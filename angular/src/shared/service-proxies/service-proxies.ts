...
export class CategoryServiceProxy {
     ...
     * @return Success
     */
    create(body: CategoryCreateInput | undefined): Observable<void> {
     ...
     * @return Success
     */
    getAll(): Observable<CategoryListDtoListResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CategoryListDtoListResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<CategoryListDtoListResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<CategoryListDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CategoryListDtoListResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CategoryListDtoListResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    getById(id: string | undefined): Observable<CategoryListDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CategoryListDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<CategoryListDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetById(response: HttpResponseBase): Observable<CategoryListDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<CategoryListDto>(<any>null);
    }
...
export class PostServiceProxy {
     ...
     * @return Success
     */
    create(body: PostCreateInput | undefined): Observable<void> {
     ...
     * @return Success
     */
    getAll(): Observable<PostListDtoListResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PostListDtoListResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PostListDtoListResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PostListDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PostListDtoListResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PostListDtoListResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    getByAuthorId(id: string | undefined): Observable<PostListDto> {
        let url_ = this.baseUrl + "/api/services/app/Post/GetByAuthorId?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetByAuthorId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetByAuthorId(<any>response_);
                } catch (e) {
    ...
    protected processGetByAuthorId(response: HttpResponseBase): Observable<PostListDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class CategoryListDtoListResultDto implements ICategoryListDtoListResultDto {
    items: CategoryListDto[] | undefined;

    constructor(data?: ICategoryListDtoListResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CategoryListDtoListResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new CategoryListDtoListResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): CategoryListDtoListResultDto {
        const json = this.toJSON();
        let result = new CategoryListDtoListResultDto();
        result.init(json);
        return result;
...
export interface ICategoryListDtoListResultDto {
    items: CategoryListDto[] | undefined;
}
...
export class PostCreateInput implements IPostCreateInput {
    ...
    constructor(data?: IPostCreateInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PostCreateInput {
        data = typeof data === 'object' ? data : {};
        let result = new PostCreateInput();
        result.init(data);
        return result;
    }
...
export class PostListDtoListResultDto implements IPostListDtoListResultDto {
    items: PostListDto[] | undefined;

    constructor(data?: IPostListDtoListResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PostListDtoListResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new PostListDtoListResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): PostListDtoListResultDto {
        const json = this.toJSON();
        let result = new PostListDtoListResultDto();
        result.init(json);
        return result;
...
export interface IPostListDtoListResultDto {
    items: PostListDto[] | undefined;
}
