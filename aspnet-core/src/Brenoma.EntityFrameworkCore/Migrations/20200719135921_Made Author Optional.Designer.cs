...
namespace Brenoma.Migrations
{
    ...
    [Migration("20200719135921_Made Author Optional")]
    partial class MadeAuthorOptional
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Brenoma.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Brenoma.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Brenoma.Posts.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Brenoma.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Brenoma.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Brenoma.Posts.Post", b =>
                {
                    b.HasOne("Brenoma.Authors.Author", "Author")
                        .WithMany("Posts")
                        .HasForeignKey("AuthorId");

                    b.HasOne("Brenoma.Categories.Category", "Category")
                        .WithMany("Posts")
