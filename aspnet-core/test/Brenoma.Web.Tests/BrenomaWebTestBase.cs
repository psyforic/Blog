...
using Brenoma.Models.TokenAuth;
...
{
    public abstract class BrenomaWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BrenomaWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BrenomaWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BrenomaDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BrenomaDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BrenomaDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BrenomaDbContext, Task<T>> func)
        {
            T result;
